...
class _DashboardState extends State<Dashboard> {
  ...
  Future<void> fetchComplaintCounts() async {
    try {
      final token =
          await getAuthToken(); // Implement getAuthToken() to fetch the user's token
      final response = await http.get(
        Uri.parse(
            'https://d8ae-103-185-109-76.ngrok-free.app/complaints/counts'),
        headers: {
                  ...
                  Positioned(
                    ...
                    child: SizedBox(
                      ...
                      child: FloatingActionButton(
                        ...
                        backgroundColor:
                            const Color.fromARGB(255, 254, 183, 101),
                        mini: true,
